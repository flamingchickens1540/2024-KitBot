...
public class Drivetrain extends SubsystemBase {
  ...
  public void tankDrive(double leftSpeed, double rightSpeed) {
    double deadzonedLeftSpeed = MathUtil.applyDeadband(leftSpeed, 0.1);
    double deadzonedRightSpeed = MathUtil.applyDeadband(rightSpeed, 0.1);
    m_drivetrain.tankDrive(deadzonedLeftSpeed, deadzonedRightSpeed);
  }
